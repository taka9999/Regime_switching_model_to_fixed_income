...
for pname, (umodel, ext_features_df) in patterns.items():
    ...
    while t0 + relativedelta(months=pred_months) <= val_end:
        ...
        xgb_full = XGBClassifier(objective='binary:logistic',eval_metric='logloss',random_state=42, reg_alpha = best_alpha)
...
import pickle
resdir = 'results'
nbname = 'UST10_cont1.4.5_GPU_lin+rqker_rqpen_v2'
